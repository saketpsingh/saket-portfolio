...
export const metadata: Metadata = {
  title: "Page Not Found | Saket Singh",
  description: "The page you're looking for doesn't exist. Return to Saket Singh's portfolio to continue exploring his work and achievements."
};
